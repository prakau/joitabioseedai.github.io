...
try {
  ...
  await page.reload();
  await page.getByRole("button", { name: "Toggle navigation" }).click(); await page.getByRole("navigation", { name: "JOITAFA modules" }).getByRole("link", {name:"Ask",exact:true}).click();
  ...
  await page.getByRole("navigation",{name:"JOITAFA modules"}).getByRole("link",{name:"Calculators",exact:true}).click();
  ...
  await page.getByRole("button",{name:"Toggle navigation",exact:true}).click();
  await page.getByRole("navigation",{name:"JOITAFA modules"}).getByRole("link",{name:"Income & Costs",exact:true}).click();
