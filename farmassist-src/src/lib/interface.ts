...
const hindi: Record<string, string> = {
  ...
  "FarmAssist home": "FarmAssist होम", "JOITA website": "JOITA वेबसाइट", "Toggle navigation": "मेन्यू खोलें या बंद करें",
  ...
  "Crop advisory support only": "केवल फसल सलाह में सहायता", "Ask JOITA": "JOITA से पूछें", "OUT IN THE FIELD": "खेत के काम",
  ...
  "FarmAssist is in pilot mode. Responses are AI-assisted and should be confirmed with local expert recommendations.": "FarmAssist अभी पायलट चरण में है। जवाब AI की सहायता से दिए जाते हैं। स्थानीय कृषि विशेषज्ञ से पुष्टि करें।",
