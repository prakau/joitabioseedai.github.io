      ...
      <header className="farm-shell sticky top-0 z-20 border-b border-sage-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-black tracking-normal text-black">JOITA FarmAssist</h1>
        ...
        <nav className="grid grid-cols-3 gap-2 sm:grid-cols-4 lg:block lg:space-y-2" aria-label="FarmAssist modules">
          {nav.map((item) => {
            ...
            return (
              <button
                key={item.id}
                className={`nav-button flex min-h-12 items-center justify-center gap-2 rounded-md border px-4 py-2.5 text-base font-bold transition lg:w-full lg:justify-start ${
        ...
        <Card className="chat-card overflow-hidden">
          <CardHeader className="chat-hero border-b border-sage-100">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <CardTitle className="mt-3 flex items-center gap-2 text-3xl"><Bot className="h-7 w-7" /> Ask FarmAssist</CardTitle>
          ...
          <div className="space-y-3">
            <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
              ...
              <label className="flex min-h-11 cursor-pointer items-center justify-center rounded-md border border-sage-700 bg-sage-100 px-4 py-2.5 text-base font-bold text-black hover:bg-sage-200">
                Upload crop photo
