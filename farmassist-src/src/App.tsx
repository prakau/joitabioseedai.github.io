...
export default function App() {
  ...
  const [settings, setSettings] = useState<SettingsState>(() => safeJsonParse(localStorage.getItem(keys.settings), { dataGovKey: "", plantNetKey: "", enableTransformers: false, farmName: "JOITA demo farm", village: "Haryana village" }));
  ...
  ], [questions.length, ehiReadings.length, soilReports.length, layouts.length, posts.length]);
